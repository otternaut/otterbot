...
| Skill | What it does |
| --- | --- |
| [`otterbot-review-orchestrator`](skills/otterbot-review-orchestrator/SKILL.md) | Sweeps a GitHub repository for new code reviews, incomplete-review recovery, and changed-evidence gate reassessments, using one isolated Ollie worker per eligible PR. |
| [`otterbot-review`](skills/otterbot-review/SKILL.md) | Ollie the otter reviews PRs and local diffs for evidenced bugs, posts concise inline findings with a verdict, and handles incremental re-reviews. |
<!-- END SKILLS TABLE -->
