...
| Skill | What it does |
| --- | --- |
| [`otterbot-review`](skills/otterbot-review/SKILL.md) | Perform a principal-level code review, producing a structured Review Council post with Specialist Scores and inline source-specific findings. |
<!-- END SKILLS TABLE -->
