...
| Skill | What it does |
| --- | --- |
| [`otterbot-review`](skills/otterbot-review/SKILL.md) | Perform an adversarial principal-architect code review that tries to prove the change unsafe before approving it, producing a structured Review Council post with Specialist Scores and inline source-specific findings. |
<!-- END SKILLS TABLE -->
