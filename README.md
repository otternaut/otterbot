...
| Skill | What it does |
| --- | --- |
| [`otterbot-review-orchestrator`](skills/otterbot-review-orchestrator/SKILL.md) | Orchestrates independent Ollie (Otterbot) reviews for fresh, changed, non-draft GitHub pull requests that still need a review. |
