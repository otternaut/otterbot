...
| Skill | What it does |
| --- | --- |
| [`otterbot-review`](skills/otterbot-review/SKILL.md) | Perform a principal-level code review, producing a structured Markdown report with severity-tagged findings and Specialist Scores. |
<!-- END SKILLS TABLE -->
