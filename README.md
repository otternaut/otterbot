...
| Skill | What it does |
| --- | --- |
| [`otterbot-review-orchestrator`](skills/otterbot-review-orchestrator/SKILL.md) | Sweeps a GitHub repository's open pull requests and runs an independent Ollie (Otterbot) review on each one that still needs it. |
| [`otterbot-review`](skills/otterbot-review/SKILL.md) | Ollie the otter reviews a pull request like a skeptical principal architect and posts every finding as an inline comment with severity, evidence, risk, and a concrete fix, plus a short root summary with a verdict. |
<!-- END SKILLS TABLE -->
